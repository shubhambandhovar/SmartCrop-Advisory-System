...
export default function AdaBoostChart({ data }) {
    if (!data || !data.features) return <p>No AdaBoost data available.</p>;
    ...
    return (
        <div style={{ textAlign: 'center', width: '100%' }}>
            <h3>AdaBoost Feature Importance</h3>
            <p>Feature contribution weights in AdaBoost classifier.</p>
